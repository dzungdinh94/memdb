...
MemdbConnection.STATES = STATES;

/*!
 * Inherits from Connection.
 */

MemdbConnection.prototype.__proto__ = MongooseConnection.prototype;
...
MemdbConnection.prototype.doOpen = function (fn) {
  if (this.db) {
    mute(this);
  }
...
MemdbConnection.prototype.useDb = function (name) {
 ...
 *
 * See description of [doOpen](#MemdbConnection-doOpen) for server options. In this case `options.replset` is also passed to ReplSetServers.
 *
 * @param {Function} fn
 * @api private
 * @return {Connection} this
...
MemdbConnection.prototype.doOpenSet = function (fn) {
  if (this.db) {
    mute(this);
  }
...
MemdbConnection.prototype.doClose = function (fn) {
  this.db.close();
  if (fn) fn();
  return this;
}
...
MemdbConnection.prototype.parseOptions = function (passed, connStrOpts) {
  var o = passed || {};
  o.db || (o.db = {});
  o.auth || (o.auth = {});
  o.server || (o.server = {});
...
module.exports = MemdbConnection;
